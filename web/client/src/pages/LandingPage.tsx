  ...
  return (
    <div className="bg-white">
              ...
              <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                <h1 className="text-4xl font-extrabold tracking-tight text-center sm:text-5xl lg:text-6xl">
                  <span className="block text-gray-800">
                    Split bills with your friends & family
                  </span>
                ...
                <p className="max-w-lg mx-auto mt-6 text-xl text-center text-gray-500 sm:max-w-3xl">
                  Split bills with your friends & family, easily and efficiently. Register
      ...
      <footer className="bg-gray-50" aria-labelledby="footer-heading">
        ...
        <div className="px-4 mx-auto sm:px-6 lg:px-8 "> {/**pt-16 pb-8 max-w-7xl lg:pt-24 */}
          {/* <div className="flex items-center justify-between">
            <div>
              <h3 className="text-sm font-semibold tracking-wider text-gray-400 uppercase">
                Follow Me
              </h3>
              <div className="flex items-center justify-between mt-6 w-fit">
                <div>
                  <a
                    href="https://github.com/akkilmg"
                    target="_blank"
          ...
          <div className="justify-center pt-8 mt-12 text-center md:flex md:items-center md:justify-between lg:mt-16"> {/*  border-t border-gray-200 */}
            <p className="mt-8 text-base text-gray-400 md:order-1 md:mt-0">
              Made with ❤️ by <a className="hover:text-blue-500" href="https://github.com/akkilmg">Akkil</a>
            </p>
          </div>
        </div>
      </footer>
